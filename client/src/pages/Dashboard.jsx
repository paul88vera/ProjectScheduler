...
export default function Dashboard() {
  ...
  return (
    <div
      ...
      className="p-4 md:p-16 grid grid-cols-1 gap-4 md:gap-4 w-full max-h-[100svh]">
      <div
        id="top_grid"
      ...
      <div
        ...
        <button className="button rounded-md hover:bg-[--global-color-light-accent] text-[1.5rem]">
          <HiArrowSmLeft />
        </button>
        <button className="button rounded-md hover:bg-[--global-color-light-accent] text-[1.5rem]">
          <HiArrowSmRight />
